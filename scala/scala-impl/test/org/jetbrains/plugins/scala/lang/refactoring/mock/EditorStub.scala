...
class EditorStub extends Editor {
  ...
  override def getInlayModel: InlayModel = new InlayModel {
    ...
    override def addInlineElement[T <: EditorCustomElementRenderer](offset: Int, properties: InlayProperties, renderer: T): Inlay[T] = null

    override def addBlockElement[T <: EditorCustomElementRenderer](offset: Int, properties: InlayProperties, renderer: T): Inlay[T] = null

    override def addAfterLineEndElement[T <: EditorCustomElementRenderer](offset: Int, properties: InlayProperties, renderer: T): Inlay[T] = null
  }
