...
object ImplicitResolveResult {
  ...
  private[this] def findImplicitConversion(expressionType: ScType,
                                          ...
                                          (implicit place: ScExpression): Option[ScalaResolveResult] = DebugLogger.func() {
    ...
    def checkImplicits(noApplicability: Boolean = false, withoutImplicitsForArgs: Boolean = noImplicitsForArgs): Seq[ScalaResolveResult] = DebugLogger.func() {
