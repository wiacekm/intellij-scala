...
case class MostSpecificUtil(elem: PsiElement, length: Int) {
  ...
  def mostSpecificForResolveResult(applicable: Set[ScalaResolveResult],
                                   expandInnerResult: Boolean = true): Option[ScalaResolveResult] = DebugLogger.func(this) {
  ...
  def mostSpecificForImplicitParameters(applicable: Set[ScalaResolveResult]): Option[ScalaResolveResult] = DebugLogger.func(this) {
